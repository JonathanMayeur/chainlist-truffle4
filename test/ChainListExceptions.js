...
contract("ChainList", function(accounts){
  ...
  it("should throw an axception if you try to buy an article when there is no article for sale yet", function(){
  ...
  it("should throw an exception if you try to buy an article that has already been sold", function() {
    ...
    .catch(function(error){
      ...
      assert.equal(data[0].toNumber(), 1, "article 1 must be 1");
      assert.equal(data[1], seller, "seller must be " + seller);
